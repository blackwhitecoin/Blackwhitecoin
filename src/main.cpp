...
int64 nChainStartTime = 1398238978;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1398238978;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1347351;
        ...
        assert(block.hashMerkleRoot == uint256("0x62941742469ad1cf4914302828910c197cdc56d1ee0118321df1d1d3c8fcced1"));
